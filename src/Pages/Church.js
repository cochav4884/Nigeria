      ...
      <div className="container">
        ...
        <section className="section">
          ...
          <p>
            ...
            State, Nigeria. It's a place to worship, gather with friends, repent
            & be forgiven, and enjoy the Holy Spirit... the Heartbeat of God
            (HBG) is the place for you.
          </p>
        </section>
        ...
        <section className="section">
          ...
          <p>
            ...
            church, and may God bless you and your loved ones in Jesus's Mighty
            Name... AMEN!
          </p>
        </section>
        ...
        <section className="section">
          ...
          <p>
            ...
            gather amongst friends, a place to repent & be forgiven, a place to
            enjoy the Holy Spirit... the Heartbeat of God (HBG) is the place for
            you.
          </p>
        </section>
        ...
        <section className="interview-section">
          <blockquote>
            <p>
              <strong>Richie:</strong> What is the first thought that comes to
              mind when you think of this Church building?
            </p>
            <p>
              <strong>Pastor Amos Onogwu:</strong> "This building holds
              memories, life-changing stories, and transformations. It has seen
              countless moments of prayer, faith, and love. We consider it holy
              ground."
            </p>
            ...
            <p>
              ...
              come together to build a relationship with Christ. It's a place
              where we all grow, as individuals and as a community."
            </p>
          </blockquote>
        </section>
      </div>
